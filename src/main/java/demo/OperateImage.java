...
public class OperateImage {
     ...
     */
    public static void cropImage(String srcImagePath, String toImagePath,
                                 int x, int y, int width, int height,
                                 String readImageFormat, String writeImageFormat) throws IOException {
        try (FileInputStream fileInputStream = new FileInputStream(srcImagePath);
            ...
            BufferedImage tag = imageReader.read(0, imageReadParam);
            // 保存新图片
            ImageIO.write(tag, writeImageFormat, new File(toImagePath));
        }
    }
    ...
    public byte[] cropImage(byte[] bytes, int[] position, String readImageFormat, String writeImageFormat) throws IOException {
        ...
        try (InputStream inputStream = new ByteArrayInputStream(bytes);
            ...
            BufferedImage tag = imageReader.read(0, imageReadParam);
            // 保存新图片
            ImageIO.write(tag, writeImageFormat, byteArrayOutputStream);
    ...
    public void reduceImageByRatio(String srcImagePath, String toImagePath, int widthRatio, int heightRatio) throws IOException {
        try (FileOutputStream fileOutputStream = new FileOutputStream(toImagePath)) {
            ...
            ImageIO.write(tag, "JPG", fileOutputStream);
        }
    }
    ...
    public void joinImagesHorizontal(String firstSrcImagePath, String secondSrcImagePath, String imageFormat, String toPath) {
        try {
            ...
            int width = firstBufferedImage.getWidth();
            int height = firstBufferedImage.getHeight();
            // 从图片中读取RGB
            int[] firstImageArray = new int[width * height];
            firstImageArray = firstBufferedImage.getRGB(0, 0, width, height, firstImageArray, 0, width);

            // 对第二张图片做相同的处理
            File secondFile = new File(secondSrcImagePath);
            BufferedImage secondBufferedImage = ImageIO.read(secondFile);
            int width2 = secondBufferedImage.getWidth();
            int height2 = secondBufferedImage.getHeight();
            int[] secondImageArray = new int[width2 * height2];
            secondImageArray = secondBufferedImage.getRGB(0, 0, width, height, secondImageArray, 0, width);
            // secondImageArray  =  secondBufferedImage.getRGB(0,0,width2,height2,ImageArrayTwo,0,width2);

            // 生成新图片
            // int height3 = (height>height2 || height==height2)?height:height2;
            BufferedImage tag = new BufferedImage(width * 2, height, BufferedImage.TYPE_INT_RGB);
            // BufferedImage tag = new  BufferedImage(width+width2,height3,BufferedImage.TYPE_INT_RGB);
            // 设置左半部分的RGB
            tag.setRGB(0, 0, width, height, firstImageArray, 0, width);
            // 设置右半部分的RGB
            tag.setRGB(width, 0, width, height, secondImageArray, 0, width);
            // tag.setRGB(width,0,width2,height2,ImageArrayTwo,0,width2);//设置右半部分的RGB

            File outFile = new File(toPath);
            // 写图片
            ImageIO.write(tag, imageFormat, outFile);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean joinImageListHorizontal(String[] pics, String type, String dstPic) {
        try {
            ...
            for (int i = 0; i < images.length; i++) {
                dstHeight = Math.max(dstHeight, images[i].getHeight());
            ...
            int width = 0;
            for (int i = 0; i < images.length; i++) {
                tag.setRGB(width, 0, images[i].getWidth(), dstHeight, imageArrays[i], 0, images[i].getWidth());
                width += images[i].getWidth();
            }
            File outFile = new File(dstPic);
            // 写图片
            ImageIO.write(tag, type, outFile);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public void mergeBothImage(String negativeImagePath, String additionImagePath, int x, int y, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
             InputStream inputStream2 = new FileInputStream(additionImagePath);
            ...
            g.drawImage(bufferedImage2, x, y, null);
        ...
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            if (additionImageList != null) {
                for (int i = 0; i < additionImageList.size(); i++) {
                    ...
                    // 读取文件输入流，并合并图片
                    inputStream2 = new FileInputStream(additionImagePath);
                    bufferedImage2 = ImageIO.read(inputStream2);
                    graphics2D.drawImage(bufferedImage2, x, y, null);
                }
            }
            ImageIO.write(bufferedImage1, imageFormat, outputStream);
        } finally {
    ...
    public void mergeBothImageToprightcorner(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, bufferedImage1.getWidth() - bufferedImage2.getWidth(), 0, null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageLeftbottom(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, 0, bufferedImage1.getHeight() - bufferedImage2.getHeight(), null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageRightbottom(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, bufferedImage1.getWidth() - bufferedImage2.getWidth(), bufferedImage1.getHeight() - bufferedImage2.getHeight(), null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageCenter(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, bufferedImage1.getWidth() / 2 - bufferedImage2.getWidth() / 2, bufferedImage1.getHeight() / 2 - bufferedImage2.getHeight() / 2, null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageTopcenter(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, bufferedImage1.getWidth() / 2 - bufferedImage2.getWidth() / 2, 0, null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageBottomcenter(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics g = bufferedImage1.getGraphics();
            g.drawImage(bufferedImage2, bufferedImage1.getWidth() / 2 - bufferedImage2.getWidth() / 2, bufferedImage1.getHeight() - bufferedImage2.getHeight(), null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageLeftcenter(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics g = bufferedImage1.getGraphics();
            g.drawImage(bufferedImage2, 0, bufferedImage1.getHeight() / 2 - bufferedImage2.getHeight() / 2, null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
    ...
    public void mergeBothImageRightcenter(String negativeImagePath, String additionImagePath, String toPath) throws IOException {
        try (InputStream inputStream1 = new FileInputStream(negativeImagePath);
            ...
            BufferedImage bufferedImage2 = ImageIO.read(inputStream2);
            Graphics graphics = bufferedImage1.getGraphics();
            graphics.drawImage(bufferedImage2, bufferedImage1.getWidth() - bufferedImage2.getWidth(), bufferedImage1.getHeight() / 2 - bufferedImage2.getHeight() / 2, null);
            ImageIO.write(bufferedImage1, "JPG", outputStream);
        }
    }
